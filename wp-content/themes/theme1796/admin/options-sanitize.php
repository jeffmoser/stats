...
function of_recognized_font_lineheight() {
	$default = array(
		'13'        => __('13px', 'options_framework_theme'),
		'14'        => __('14px', 'options_framework_theme'),
		'15'        => __('15px', 'options_framework_theme'),
		'16'        => __('16px', 'options_framework_theme'),
		'17'        => __('17px', 'options_framework_theme'),
		'18'        => __('18px', 'options_framework_theme'),
		'19'        => __('19px', 'options_framework_theme'),
		'20'        => __('20px', 'options_framework_theme'),
		'21'        => __('21px', 'options_framework_theme'),
		'22'        => __('22px', 'options_framework_theme'),
		'23'        => __('23px', 'options_framework_theme'),
		'24'        => __('24px', 'options_framework_theme'),
		'25'        => __('25px', 'options_framework_theme'),
		'26'        => __('26px', 'options_framework_theme'),
		'27'        => __('27px', 'options_framework_theme'),
		'28'        => __('28px', 'options_framework_theme'),
		'29'        => __('29px', 'options_framework_theme'),
		'30'        => __('30px', 'options_framework_theme'),
		'31'        => __('31px', 'options_framework_theme'),
		'32'        => __('32px', 'options_framework_theme'),
		'33'        => __('33px', 'options_framework_theme'),
		'34'        => __('34px', 'options_framework_theme'),
		'35'        => __('35px', 'options_framework_theme'),
		'36'        => __('36px', 'options_framework_theme'),
		'37'        => __('37px', 'options_framework_theme'),
		'38'        => __('38px', 'options_framework_theme'),
		'39'        => __('39px', 'options_framework_theme'),
		'40'        => __('40px', 'options_framework_theme'),
		'41'        => __('41px', 'options_framework_theme'),
		'42'        => __('42px', 'options_framework_theme'),
		'43'        => __('43px', 'options_framework_theme'),
		'44'        => __('44px', 'options_framework_theme'),
		'45'        => __('45px', 'options_framework_theme'),
		'46'        => __('46px', 'options_framework_theme'),
		'47'        => __('47px', 'options_framework_theme'),
		'48'        => __('48px', 'options_framework_theme'),
		'49'        => __('49px', 'options_framework_theme'),
		'50'        => __('50px', 'options_framework_theme'),
		'51'        => __('51px', 'options_framework_theme'),
		'52'        => __('52px', 'options_framework_theme'),
		'53'        => __('53px', 'options_framework_theme'),
		'54'        => __('54px', 'options_framework_theme'),
		'55'        => __('55px', 'options_framework_theme'),
		'56'        => __('56px', 'options_framework_theme'),
		'57'        => __('57px', 'options_framework_theme'),
		'58'        => __('58px', 'options_framework_theme'),
		'59'        => __('59px', 'options_framework_theme'),
		'60'        => __('60px', 'options_framework_theme'),
		'61'        => __('61px', 'options_framework_theme'),
		'62'        => __('62px', 'options_framework_theme'),
		'63'        => __('63px', 'options_framework_theme'),
		'64'        => __('64px', 'options_framework_theme'),
		'65' => __('65px', 'options_framework_theme')
		);
...
function options_typography_font_styles($option, $selectors) {
		$output = $selectors . ' { ';
		$output .= 'font: ' . $option['style'] . ' ' . $option['size'] . '/'.$option['lineheight'].'px ' . $option['face'] . '; ';
