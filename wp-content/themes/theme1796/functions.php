<?php
	...
	load_theme_textdomain( 'theme1796', PARENT_DIR . '/languages' );
 ...
 */
    ...
    if(!function_exists('bm_get_portfolio_tags')) {
        
        function bm_get_portfolio_tags($postId) {
            
            $terms = get_the_terms( $postId , 'portfolio_tags' );
            $slug = '';
            if(is_array($terms)) {
