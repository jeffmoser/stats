			...
			<?php endif; ?>
				...
				<div class="post-meta-wrapper">
					...
					<?php if ( $instance['date'] ) : ?>
						<span class="post_meta"><!--Written by <?php the_author_posts_link() ?>--> <time datetime="<?php the_time('Y-m-d\TH:i'); ?>"><?php the_time(get_option( 'date_format' )); ?> <?php the_time() ?></time></span>
					<?php endif; ?>
