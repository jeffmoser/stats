...
$meta_box_slider = array(
	...
	'title' =>  __('Slider Options', 'theme1796'),
	'page' => 'slider',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Caption', 'theme1796'),
    	   'desc' => __('Input your caption for slide (HTML tags are allowed). ', 'theme1796'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input the slide URL (can be external link)', 'theme1796'),
...
function my_show_box_slider() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for slide. ', 'theme1796').'</p>';
