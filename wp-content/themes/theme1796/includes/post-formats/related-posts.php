...
if ($tags) {
	...
	<?php if($blog_related){?>
		<h3 class="sp-title"><?php echo of_get_option('blog_related'); ?></h3>
	<?php } else { ?>
		<h3 class="sp-title"><?php _e('Related Posts','theme1796');?></h3>
	<?php } ?>
			...
			?>
				<li>
					<?php if(has_post_thumbnail()) { ?>
						...
						$image = aq_resize( $img_url, 186, 120, true ); //resize & crop img
						?>
