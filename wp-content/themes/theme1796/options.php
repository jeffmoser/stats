...
if(!function_exists('optionsframework_options')) {
	...
	function optionsframework_options() {
		...
		$options['google_mixed_3'] = array( 'name' => 'Body Text',
							...
							'id' => 'google_mixed_3',
							'std' => array( 'size' => '12px', 'face' => 'Arial', 'color' => ''),
							'type' => 'typography',
							'options' => array(
		...
		$options['h1_heading'] = array( 'name' => 'H1 Heading',
							...
							'id' => 'h1_heading',
							'std' => array( 'size' => '32px', 'face' => 'Arial', 'color' => ''),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h2_heading'] = array( 'name' => 'H2 Heading',
							...
							'id' => 'h2_heading',
							'std' => array( 'size' => '24px', 'face' => 'Arial', 'color' => ''),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h3_heading'] = array( 'name' => 'H3 Heading',
							...
							'id' => 'h3_heading',
							'std' => array( 'size' => '18px', 'face' => 'Arial', 'color' => ''),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h4_heading'] = array( 'name' => 'H4 Heading',
							...
							'id' => 'h4_heading',
							'std' => array( 'size' => '14px', 'face' => 'Arial', 'color' => ''),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h6_heading'] = array( 'name' => 'H6 Heading',
							...
							'id' => 'h6_heading',
							'std' => array( 'size' => '10px', 'face' => 'Arial', 'color' => ''),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
...
*/
add_action( 'customize_register', 'theme1796_register' );

if(!function_exists('theme1796_register')) {

	function theme1796_register($wp_customize) {
		/**
		...
		/*	General
		/*-----------------------------------------------------------------------------------*/
		$wp_customize->add_section( 'theme1796_header', array(
			'title' => __( 'General', 'theme1796' ),
			'priority' => 200
		));
		
		/* Background Image*/
		$wp_customize->add_setting( 'theme1796[body_background][image]', array(
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'body_background_image', array(
			...
			'section' => 'theme1796_header',
			'settings'   => 'theme1796[body_background][image]'
		) ) );
		
		
		/* Background Color*/
		$wp_customize->add_setting( 'theme1796[body_background][color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'body_background', array(
			...
			'section' => 'theme1796_header',
			'settings'   => 'theme1796[body_background][color]'
		) ) );
		
		/* Header Color */
		$wp_customize->add_setting( 'theme1796[header_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_color', array(
			...
			'section' => 'theme1796_header',
			'settings'   => 'theme1796[header_color]'
		) ) );
		
		
		/* Body Font Face */
		$wp_customize->add_setting( 'theme1796[google_mixed_3][face]', array(
			'default' => $options['google_mixed_3']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1796_google_mixed_3', array(
				'label' => $options['google_mixed_3']['name'],
				'section' => 'theme1796_header',
				'settings' => 'theme1796[google_mixed_3][face]',
				'type' => 'select',
		...
		$wp_customize->add_setting( 'theme1796[links_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'links_color', array(
			...
			'section' => 'theme1796_header',
			'settings'   => 'theme1796[links_color]'
		) ) );
		
		/* H1 Heading font face */
		$wp_customize->add_setting( 'theme1796[h1_heading][face]', array(
			'default' => $options['h1_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1796_h1_heading', array(
				'label' => $options['h1_heading']['name'],
				'section' => 'theme1796_header',
				'settings' => 'theme1796[h1_heading][face]',
				'type' => 'select',
				'choices' => $options['h1_heading']['options']['faces']
		) );
		
		/* H2 Heading font face */
		$wp_customize->add_setting( 'theme1796[h2_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1796_h2_heading', array(
				'label' => $options['h2_heading']['name'],
				'section' => 'theme1796_header',
				'settings' => 'theme1796[h2_heading][face]',
				'type' => 'select',
				'choices' => $options['h2_heading']['options']['faces']
		) );
		
		/* H6 Heading font face */
		$wp_customize->add_setting( 'theme1796[h6_heading][face]', array(
			'default' => $options['h6_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1796_h6_heading', array(
				'label' => $options['h6_heading']['name'],
				'section' => 'theme1796_header',
				'settings' => 'theme1796[h6_heading][face]',
				'type' => 'select',
				'choices' => $options['h6_heading']['options']['faces']
		) );
		
		/* H5 Heading font face */
		$wp_customize->add_setting( 'theme1796[h5_heading][face]', array(
			'default' => $options['h5_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1796_h5_heading', array(
				'label' => $options['h5_heading']['name'],
				'section' => 'theme1796_header',
				'settings' => 'theme1796[h5_heading][face]',
				'type' => 'select',
				'choices' => $options['h5_heading']['options']['faces']
		) );
		
		/* H4 Heading font face */
		$wp_customize->add_setting( 'theme1796[h4_heading][face]', array(
			'default' => $options['h4_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1796_h4_heading', array(
				'label' => $options['h4_heading']['name'],
				'section' => 'theme1796_header',
				'settings' => 'theme1796[h4_heading][face]',
				'type' => 'select',
				'choices' => $options['h4_heading']['options']['faces']
		) );
		
		/* H3 Heading font face */
		$wp_customize->add_setting( 'theme1796[h3_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1796_h3_heading', array(
				'label' => $options['h3_heading']['name'],
				'section' => 'theme1796_header',
				'settings' => 'theme1796[h3_heading][face]',
				'type' => 'select',
		...
		/* Search Box */
		$wp_customize->add_setting( 'theme1796[g_search_box_id]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_g_search_box_id', array(
				'label' => $options['g_search_box_id']['name'],
				'section' => 'theme1796_header',
				'settings' => 'theme1796[g_search_box_id]',
		...
		$wp_customize->add_section( 'theme1796_logo', array(
			'title' => __( 'Logo', 'theme1796' ),
			'priority' => 201
		) );
		
		/* Logo Type */
		$wp_customize->add_setting( 'theme1796[logo_type]', array(
				'default' => $options['logo_type']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_logo_type', array(
				'label' => $options['logo_type']['name'],
				'section' => 'theme1796_logo',
				'settings' => 'theme1796[logo_type]',
				'type' => $options['logo_type']['type'],
				'choices' => $options['logo_type']['options']
		) );
		
		/* Logo Path */
		$wp_customize->add_setting( 'theme1796[logo_url]', array(
			'type' => 'option'
		) );
		...
		$wp_customize->add_section( 'theme1796_slider', array(
			'title' => __( 'Slider', 'theme1796' ),
			'priority' => 202
		) );
		
		/* Slider Effect */
		$wp_customize->add_setting( 'theme1796[sl_effect]', array(
				'default' => $options['sl_effect']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_sl_effect', array(
				'label' => $options['sl_effect']['name'],
				'section' => 'theme1796_slider',
				'settings' => 'theme1796[sl_effect]',
				'type' => $options['sl_effect']['type'],
				'choices' => $options['sl_effect']['options']
		) );
		
		/* Pause time */
		$wp_customize->add_setting( 'theme1796[sl_pausetime]', array(
				'default' => $options['sl_pausetime']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_sl_pausetime', array(
				'label' => $options['sl_pausetime']['name'],
				'section' => 'theme1796_slider',
				'settings' => 'theme1796[sl_pausetime]',
				'type' => $options['sl_pausetime']['type']
		) );
		
		/* Animation speed */
		$wp_customize->add_setting( 'theme1796[sl_animation_speed]', array(
				'default' => $options['sl_animation_speed']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_sl_animation_speed', array(
				'label' => $options['sl_animation_speed']['name'],
				'section' => 'theme1796_slider',
				'settings' => 'theme1796[sl_animation_speed]',
				'type' => $options['sl_animation_speed']['type']
		) );
		
		/* Auto slideshow */
		$wp_customize->add_setting( 'theme1796[sl_slideshow]', array(
				'default' => $options['sl_slideshow']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_sl_slideshow', array(
				'label' => $options['sl_slideshow']['name'],
				'section' => 'theme1796_slider',
				'settings' => 'theme1796[sl_slideshow]',
				'type' => $options['sl_slideshow']['type'],
				'choices' => $options['sl_slideshow']['options']
		) );
		
		/* Slide thumbnails */
		$wp_customize->add_setting( 'theme1796[sl_thumbnails]', array(
				'default' => $options['sl_thumbnails']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_sl_thumbnails', array(
				'label' => $options['sl_thumbnails']['name'],
				'section' => 'theme1796_slider',
				'settings' => 'theme1796[sl_thumbnails]',
				'type' => $options['sl_thumbnails']['type'],
				'choices' => $options['sl_thumbnails']['options']
		) );
		
		/* Show pagination? */
		$wp_customize->add_setting( 'theme1796[sl_control_nav]', array(
				'default' => $options['sl_control_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_sl_control_nav', array(
				'label' => $options['sl_control_nav']['name'],
				'section' => 'theme1796_slider',
				'settings' => 'theme1796[sl_control_nav]',
				'type' => $options['sl_control_nav']['type'],
				'choices' => $options['sl_control_nav']['options']
		) );	
		
		/* Display next & prev navigation? */
		$wp_customize->add_setting( 'theme1796[sl_dir_nav]', array(
				'default' => $options['sl_dir_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_sl_dir_nav', array(
				'label' => $options['sl_dir_nav']['name'],
				'section' => 'theme1796_slider',
				'settings' => 'theme1796[sl_dir_nav]',
				'type' => $options['sl_dir_nav']['type'],
				'choices' => $options['sl_dir_nav']['options']
		) );
		
		/* Play/Pause button */
		$wp_customize->add_setting( 'theme1796[sl_play_pause_button]', array(
				'default' => $options['sl_play_pause_button']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_sl_play_pause_button', array(
				'label' => $options['sl_play_pause_button']['name'],
				'section' => 'theme1796_slider',
				'settings' => 'theme1796[sl_play_pause_button]',
		...
		$wp_customize->add_section( 'theme1796_blog', array(
				'title' => __( 'Blog', 'theme1796' ),
				'priority' => 203
		) );
		
		/* Blog image size */
		$wp_customize->add_setting( 'theme1796[post_image_size]', array(
				'default' => $options['post_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_post_image_size', array(
				'label' => $options['post_image_size']['name'],
				'section' => 'theme1796_blog',
				'settings' => 'theme1796[post_image_size]',
				'type' => $options['post_image_size']['type'],
				'choices' => $options['post_image_size']['options']
		) );
		
		/* Single post image size */
		$wp_customize->add_setting( 'theme1796[single_image_size]', array(
				'default' => $options['single_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_single_image_size', array(
				'label' => $options['single_image_size']['name'],
				'section' => 'theme1796_blog',
				'settings' => 'theme1796[single_image_size]',
				'type' => $options['single_image_size']['type'],
				'choices' => $options['single_image_size']['options']
		) );
		
		/* Post Meta */
		$wp_customize->add_setting( 'theme1796[post_meta]', array(
				'default' => $options['post_meta']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_post_meta', array(
				'label' => $options['post_meta']['name'],
				'section' => 'theme1796_blog',
				'settings' => 'theme1796[post_meta]',
				'type' => $options['post_meta']['type'],
				'choices' => $options['post_meta']['options']
		) );
		
		/* Post Excerpt */
		$wp_customize->add_setting( 'theme1796[post_excerpt]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_post_excerpt', array(
				'label' => $options['post_excerpt']['name'],
				'section' => 'theme1796_blog',
				'settings' => 'theme1796[post_excerpt]',
		...
		$wp_customize->add_section( 'theme1796_footer', array(
			'title' => __( 'Footer', 'theme1796' ),
			'priority' => 204
		) );
			
		/* Footer Copyright Text */
		$wp_customize->add_setting( 'theme1796[footer_text]', array(
				'default' => $options['footer_text']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_footer_text', array(
				'label' => $options['footer_text']['name'],
				'section' => 'theme1796_footer',
				'settings' => 'theme1796[footer_text]',
				'type' => 'text'
		) );
		
		
		/* Display Footer Menu */
		$wp_customize->add_setting( 'theme1796[footer_menu]', array(
				'default' => $options['footer_menu']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1796_footer_menu', array(
				'label' => $options['footer_menu']['name'],
				'section' => 'theme1796_footer',
				'settings' => 'theme1796[footer_menu]',
